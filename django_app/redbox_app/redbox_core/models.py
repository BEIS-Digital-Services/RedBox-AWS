...
def build_s3_key(instance, filename: str) -> str:
    ...
    existing_files = File.objects.filter(user=instance.user.email, original_file__startswith=f"{instance.user.email}/{base_name}").values_list('original_file', flat=True)
